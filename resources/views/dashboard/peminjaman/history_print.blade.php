...
<head>
    ...
    <style>
        ...
        .table td:nth-child(1) {
            width: 5%;
            /* Lebar kolom No lebih kecil */
            font-size: 9px;
            /* Ukuran font lebih kecil untuk kolom No */
            padding: 2px;
            /* Padding lebih kecil agar lebih kompak */
        }
                                ...
                                <ul>
                                    @if ($peminjaman->kode_barang)
                                        @foreach (json_decode($peminjaman->kode_barang) as $barangId)
                                            <li>{{ \App\Models\DataBarang::find($barangId)->nama_barang ?? 'Data Barang tidak ditemukan' }}
                                            </li>
                                        @endforeach
                                    @else
                                        <li>-</li>
                                ...
                                <ul>
                                    @if ($peminjaman->kode_ruangan)
                                        @foreach (json_decode($peminjaman->kode_ruangan) as $ruanganId)
                                            <li>{{ \App\Models\DataRuangan::find($ruanganId)->nama_ruangan ?? 'Data Ruangan tidak ditemukan' }}
                                            </li>
                                        @endforeach
                                    @else
                                        <li>-</li>
